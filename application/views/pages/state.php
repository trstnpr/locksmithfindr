...
<div class="state-content">
	...
	<section class="section-header data-img" data-bg="<?php echo base_url('build/images/banner-bg-4.jpeg'); ?>">
		<div class="overlay">
			<div class="container">
				<h1 class="txt-center"><?php echo $state->state; ?></h1>
				<br/>
				<h4 class="txt-center">Locksmith Services in <span class="location-inblock"><?php echo $state->state; ?></span></h4>
			</div>
		</div>
	</section>
    				...
    				<div class="aside">
					    ...
					    <div class="widget-map">
					    	<div class="widget-header">
    							<h3><i class="fa fa-map-pin hidden-xs"></i> <?php echo $state->state; ?></h3>
    						</div>
						    <div class="map-wrap">
